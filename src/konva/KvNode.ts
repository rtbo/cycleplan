...
export const KvNodeProps = {
  ...
  dragBoundFunc: optionalProp(
    Function as PropType<(this: Node, pos: Kv.Vector2d) => Kv.Vector2d>
  ),
  preventDefault: optionalProp(Boolean),
  globalCompositeOperation: optionalProp(String),
  filters: optionalProp(
    Array as PropType<Array<(this: Node, imageData: ImageData) => void>>
  ),
};
